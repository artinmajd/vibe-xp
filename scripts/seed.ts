...
const achievements = [
  // ─── Session 1 — What is AI & How Does It Think? (+ toolkit setup) ──────────
  // Matches the Session 1 slide deck exactly — the slide deck is the source of
  // truth. Tool is VSCode + Codex (not Cursor); the first build is a Project
  // Hub (index.html with project cards), not hello.html.

  // Block 1 — Welcome & Framing: team formation
  {
    slug: "team-names",
    session_number: 1,
    block_number: 1,
  ...
  // Block 3 — Let's Break It (HuggingFace Chat / tiny-aya-global)
  {
  ...
  // Block 4 — Stress Test & Context (pairs)
  {
    slug: "expert-witness",
    session_number: 1,
    block_number: 4,
  ...
  },
  {
    ...
    xp: 5,
    proof_type: "instructor_flag",
    proof_config: { form_type: "fields", fields: ["Detail 1", "Detail 2", "Detail 3"] },
    is_secret: false,
  },

  // Block 5 — Privacy & Cost
  {
    slug: "share-or-skip",
    session_number: 1,
    block_number: 5,
  ...
  // Block 6 — Meet Your AI Builder (VSCode + Codex)
  {
  ...
  // Block 7 — Your First Build: The Project Hub
  {
    slug: "hub-online",
    session_number: 1,
    block_number: 7,
  ...
  // Block 8 — Push It Further: Builder Menu
  {
  ...
  },
  {
    ...
    block_number: 1,
    title: "Wreck Hunt",
    description: "List six things that broke or drifted in your one-shot site — found by clicking, not just looking.",
    xp: 5,
    proof_type: "instructor_flag",
    proof_config: {
      form_type: "fields",
  ...
  // Block 2 — Plan in Four Zoom Levels
  {
    ...
    block_number: 2,
    title: "Zoom Sheet",
    description: "Complete all four zoom levels — Idea, Visitor, Pages, Details — for your real project and the wreck you found.",
    xp: 8,
    proof_type: "instructor_flag",
    proof_config: {
      form_type: "fields",
  ...
  // Block 3 — The AI Plans Too
  {
    slug: "s4-plan-generated",
    session_number: 4,
    block_number: 3,
    title: "Plan Generated",
    description: "Screenshot the AI's plan — generated in Plan Mode from your typed idea, with nothing built yet.",
    xp: 5,
    proof_type: "instructor_flag",
    proof_config: { form_type: "screenshot" },
    is_secret: false,
  },
  {
    ...
    description: "List each clarifying question the AI asked and how you answered it. If it asked none, write \"zero questions\" and take the bow.",
    xp: 5,
    proof_type: "instructor_flag",
    proof_config: {
      form_type: "fields",
  ...
  // Block 4 — The Final Build (deck labels these EARN IT slides "Block 6",
  // but nothing occupies blocks 5 or 6 in this deck — treated as block 4,
  // the direct continuation of the plan/loop/approve/build flow)
  {
    slug: "s4-the-full-stack",
    session_number: 4,
    block_number: 4,
    title: "The Full Stack",
    description: "Screenshot your chat showing all three: the plan request, one loop fix, and the scoped approval.",
    xp: 10,
    proof_type: "instructor_flag",
    proof_config: { form_type: "screenshot" },
    is_secret: false,
  ...
  // Block 7 — Ship It, Showcase & Wrap
  {
    slug: "s4-site-is-live",
    session_number: 4,
    block_number: 7,
    title: "Site Is Live",
    description: "Submit your live Vercel link — the whole three-page site, on the internet, reachable from your homepage card.",
    xp: 5,
    proof_type: "instructor_flag",
    proof_config: { form_type: "url" },
    is_secret: false,
  ...
  },
  {
    ...
    description: "Give the showcase tour on the projector — live from its URL — then tick the box.",
    xp: 5,
    proof_type: "instructor_flag",
    proof_config: {
      form_type: "checklist",
  ...
  // Block 3 — Level 2: Sketch It, Then Build It
  {
    slug: "s5-sketch-done",
    session_number: 6,
    block_number: 3,
  ...
  // Block 4 — Level 3: From a Saved File
  {
    slug: "s5-save-file",
    session_number: 6,
    block_number: 4,
  ...
  // Block 5 — Ship It: Put the Game on the Internet
  {
  ...
  // Block 6 — Showcase & Wrap: The Gate
  {
    slug: "s5-ship-it",
    session_number: 6,
    block_number: 6,
  ...
  // Block 2 — The Repair Kit: Roll Back · Look It Up · Try It
  {
  ...
  // ─── Session 10 (Hour 1) — The Finish Line ───────────────────────────────────
